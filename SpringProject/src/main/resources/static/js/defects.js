...
const SPRING_BOOT_BASE_URL = "http://192.168.0.122:80"; // Spring Boot 기본 URL (예: "http://localhost:8080") - 필요에 따라 설정
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (startButton) {
    ...
    console.error(
      "Error: Element with id 'start-script-btn' not found."
    );
  }
  ...
  if (stopButton) {
    ...
    console.error(
      "Error: Element with id 'stop-script-btn' not found."
    );
  }
});
